              ...
              <div className='container-mint7 fadeIn' >{supply}/5555 </div>
                <img src={banner} alt="" className="mint-img fadeIn" />
                  <div className="container-mint6 fadeIn">
                    <button onClick={handleDecrement} className="mint-button">-</button>

                    <input type="number" readOnly value={mintAmount} className="mint-input" />


                    <button onClick={handleIncrement} className="mint-button">+</button>

                  </div>

              {isConnected ? (
                <div className="container-mint5 fadeIn">
                  <button onClick={handleMint} className="mint-button2">Mint</button>
                </div>
              ) : (
                ...
                <div className="container-mint8 fadeIn">
                  <h2 className="mint-h2">First Minting Phase</h2>
                    <p className="mint-p3">Our first minting phase grants its holders OG passes, a total of 1,111 OG Pups, as well as many future benefits from our projects.</p>
